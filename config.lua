...
Buy = {
  ...
  {ID = 'consumable_kidneybeans_can', Type = 'Food', Name = 'Can Kidney Beans', Price = 1.5, Max = 5, Text = 'When you need to store it longer'},
  ...
  {ID = 'consumable_sugarcube', Type = 'Food', Name = 'Sugarcube', Price = 0.25, Max = 5, Text = 'A allround sweetner'},
  {ID = 'consumable_medicine', Type = 'Meds', Name = 'Medicine', Price = 12.0, Max = 5, Text = 'When you just need to feel better!'},
  ...
  {ID = 'consumable_haycube', Type = 'Misc', Name = 'HayCube', Price = 75.0, Max = 1, Text = 'Your horse will love you!'},
...
Sell = {
  {ID = 'consumable_peach', Type = 'Food', Name = 'Peach', Price = 0.50, Text = 'Sell Peach'},
